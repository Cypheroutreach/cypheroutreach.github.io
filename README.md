...
<head>
    ...
    <title>CypherOutreach - AI-Powered Cold Outreach for Cybersecurity SaaS</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <header>
        <nav class="container">
            <a href="#" class="logo">
                <svg class="logo-img" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                    <!-- Shield Background -->
                    <path d="M200 30 L340 70 L340 200 Q340 290 200 370 Q60 290 60 200 L60 70 Z" 
                          fill="#1e3a5f"/>
                    
                    <!-- White Inner Circle -->
                    <circle cx="200" cy="180" r="90" fill="#ffffff"/>
